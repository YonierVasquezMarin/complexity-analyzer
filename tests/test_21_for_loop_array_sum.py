"""
Test para verificar el análisis de complejidad de un ciclo FOR que recorre
un arreglo y suma sus elementos.

Pseudocódigo evaluado:
recorrerArreglo(arr, n) begin for i 🡨 1 to n do begin x 🡨 arr[i] suma 🡨 suma + x end return suma end
"""
...
def test_for_loop_array_sum():
    """
    PRUEBA: Ciclo FOR que recorre un arreglo y suma sus elementos
    
    Verifica que un ciclo FOR que recorre un arreglo de tamaño n
    genere la complejidad O(n), Ω(n) y Θ(n).
    """
    # Pseudocódigo a evaluar
    pseudocode = "recorrerArreglo(arr, n) begin for i 🡨 1 to n do begin x 🡨 arr[i] suma 🡨 suma + x end return suma end"
