"""
Test para verificar el análisis de complejidad de tres ciclos FOR anidados
con incremento de variable dentro del bloque más interno.

Pseudocódigo evaluado:
for i 🡨 1 to n do begin for j 🡨 1 to n do begin for k 🡨 1 to n do begin x 🡨 x + 1 end end end
"""
...
def test_triple_nested_for_loops():
    """
    PRUEBA: Tres ciclos FOR anidados
    
    Verifica que tres ciclos FOR anidados que incrementan la variable x
    generen la complejidad O(n^3), Ω(n^3) y Θ(n^3).
    """
    # Pseudocódigo a evaluar
    pseudocode = "for i 🡨 1 to n do begin for j 🡨 1 to n do begin for k 🡨 1 to n do begin x 🡨 x + 1 end end end"
