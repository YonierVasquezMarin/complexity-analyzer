"""
Test para verificar el análisis de complejidad de dos ciclos FOR secuenciales
con incremento de variables dentro de cada bloque.

Pseudocódigo evaluado:
for i 🡨 1 to n do begin x 🡨 x + 1 end for j 🡨 1 to n do begin y 🡨 y + 1 end
"""

from services.analysis_service import analyze_pseudocode


def test_sequential_for_loops():
    """
    PRUEBA: Dos ciclos FOR secuenciales con incremento
    
    Verifica que dos ciclos FOR secuenciales que incrementan variables
    generen la complejidad O(n), Ω(n) y Θ(n) con suma de complejidades secuenciales.
    """
    # Pseudocódigo a evaluar
    pseudocode = "for i 🡨 1 to n do begin x 🡨 x + 1 end for j 🡨 1 to n do begin y 🡨 y + 1 end"
