...
def test_if_then_conditional():
    """
    PRUEBA: Estructura condicional IF-THEN con asignación
    
    Verifica que una estructura condicional IF-THEN simple con una asignación
    dentro del bloque genere la complejidad O(1), Ω(1) y Θ(1).
    """
