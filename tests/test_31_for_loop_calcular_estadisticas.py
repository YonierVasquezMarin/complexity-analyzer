"""
Test para verificar el análisis de complejidad de una función que calcula
estadísticas (suma, promedio, varianza, desviación) con dos ciclos FOR secuenciales.

Pseudocódigo evaluado:
calcularEstadisticas(arr, n) begin suma 🡨 0 for i 🡨 1 to n do begin suma 🡨 suma + arr[i] end promedio 🡨 suma / n varianza 🡨 0 for i 🡨 1 to n do begin diferencia 🡨 arr[i] - promedio cuadrado 🡨 diferencia * diferencia varianza 🡨 varianza + cuadrado end varianza 🡨 varianza / n desviacion 🡨 varianza / 2 return desviacion end
"""

from services.analysis_service import analyze_pseudocode


def test_for_loop_calcular_estadisticas():
    """
    PRUEBA: Función con dos ciclos FOR secuenciales para calcular estadísticas
    
    Verifica que una función que calcula estadísticas con dos ciclos FOR
    secuenciales genere la complejidad O(n), Ω(n) y Θ(n).
    """
    # Pseudocódigo a evaluar
    pseudocode = "calcularEstadisticas(arr, n) begin suma 🡨 0 for i 🡨 1 to n do begin suma 🡨 suma + arr[i] end promedio 🡨 suma / n varianza 🡨 0 for i 🡨 1 to n do begin diferencia 🡨 arr[i] - promedio cuadrado 🡨 diferencia * diferencia varianza 🡨 varianza + cuadrado end varianza 🡨 varianza / n desviacion 🡨 varianza / 2 return desviacion end"
