"""
Test para verificar el análisis de complejidad de un algoritmo que calcula
el factorial de forma iterativa usando un ciclo FOR.

Pseudocódigo evaluado:
calcularFactorial(n) con ciclo FOR iterativo
"""
...
def test_calcular_factorial():
    """
    PRUEBA: Algoritmo para calcular factorial de forma iterativa
    
    Verifica que un algoritmo que calcula el factorial usando un ciclo FOR
    genere la complejidad O(n), Ω(n) y Θ(n).
    """
    # Pseudocódigo a evaluar
    pseudocode = """► Este algoritmo calcula el factorial de forma iterativa
calcularFactorial(n) begin
► Validar entrada
if (n < 0) then begin
return NULL
end
...
► Retornar el factorial calculado
return resultado
end"""
