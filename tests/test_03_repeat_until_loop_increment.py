"""
Test para verificar el análisis de complejidad de un ciclo REPEAT-UNTIL simple
con incremento de variable dentro del bloque.

Pseudocódigo evaluado:
repeat begin x 🡨 x + 1 end until (x > n)
"""
...
def test_repeat_until_loop_increment():
    ...
    pseudocode = "repeat begin x 🡨 x + 1 end until (x > n)"
