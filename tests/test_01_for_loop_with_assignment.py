"""
Test para verificar el análisis de complejidad de un ciclo FOR simple
con una asignación dentro del bloque.
...
def test_for_loop_with_assignment():
    """
    PRUEBA 1: Ciclo FOR simple con asignación
    
    Verifica que un ciclo FOR que itera de 1 a n con una asignación
    dentro del bloque genere la complejidad O(n), Ω(n) y Θ(n).
    """
    # Pseudocódigo a evaluar
    pseudocode = "for i 🡨 1 to n do begin x 🡨 x + 1 end"
