"""
Test para verificar el análisis de complejidad de una función que suma
los elementos de un arreglo usando un ciclo FOR.

Pseudocódigo evaluado:
sumarArreglo(A) begin n 🡨 length(A) suma 🡨 0 for i 🡨 1 to n do begin suma 🡨 suma + A[i] end return suma end
"""

from services.analysis_service import analyze_pseudocode


def test_sumar_arreglo():
    """
    PRUEBA: Función que suma elementos de un arreglo con ciclo FOR
    
    Verifica que una función que recorre un arreglo de tamaño n y suma
    sus elementos genere la complejidad O(n), Ω(n) y Θ(n).
    """
    # Pseudocódigo a evaluar
    pseudocode = "sumarArreglo(A) begin n 🡨 length(A) suma 🡨 0 for i 🡨 1 to n do begin suma 🡨 suma + A[i] end return suma end"
