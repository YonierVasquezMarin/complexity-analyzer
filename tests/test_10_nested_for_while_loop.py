"""
Test para verificar el análisis de complejidad de un ciclo FOR con un ciclo WHILE anidado
con incremento de variable dentro del bloque interno.

Pseudocódigo evaluado:
for i 🡨 1 to n do begin while (j < n) do begin x 🡨 x + 1 end end
"""
...
def test_nested_for_while_loop():
    """
    PRUEBA: Ciclo FOR con ciclo WHILE anidado
    
    Verifica que un ciclo FOR que contiene un ciclo WHILE anidado
    genere la complejidad O(n^2), Ω(n^2) y Θ(n^2).
    """
    # Pseudocódigo a evaluar
    pseudocode = "for i 🡨 1 to n do begin while (j < n) do begin x 🡨 x + 1 end end"
