"""
Test para verificar el análisis de complejidad de bucles FOR anidados que
recorren una matriz bidimensional.

Pseudocódigo evaluado:
recorrerMatriz(matriz, n) begin for i 🡨 1 to n do begin for j 🡨 1 to n do begin x 🡨 matriz[i][j] suma 🡨 suma + x end end return suma end
"""

from services.analysis_service import analyze_pseudocode


def test_nested_for_matrix_traversal():
    """
    PRUEBA: Bucles FOR anidados que recorren una matriz bidimensional
    
    Verifica que dos bucles FOR anidados que recorren una matriz de n x n
    generen la complejidad O(n^2), Ω(n^2) y Θ(n^2).
    """
    # Pseudocódigo a evaluar
    pseudocode = "recorrerMatriz(matriz, n) begin for i 🡨 1 to n do begin for j 🡨 1 to n do begin x 🡨 matriz[i][j] suma 🡨 suma + x end end return suma end"
