"""
Test para verificar el análisis de complejidad de un ciclo WHILE simple
...
def test_while_loop_increment():
    """
    PRUEBA: Ciclo WHILE simple con incremento
    
    Verifica que un ciclo WHILE que incrementa la variable i hasta n
    genere la complejidad O(n), Ω(n) y Θ(n).
    """
    # Pseudocódigo a evaluar
    pseudocode = "while (i < n) do begin i 🡨 i + 1 end"
